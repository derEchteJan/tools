...
some ~~strikethrough text~~ with **bold***and italic* in it**
also emoji :smile: and an invalid emoji :schmarn:
**bold** at the start
*italic* at the start
...
![Image standalone](https://upload.wikimedia.org/wikipedia/commons/8/8f/Example_image.svg)
...
Lorem **ipsum** dolor *sit* amet, consectetur [adipiscing](https://www.adipiscing.com) elit, sed do `eiusmod tempor incididunt` ut labore et dolore magna aliqua.
